<template>
    <div class="space-y-15">
        ...
        <div class="primary md:flex justify-between items-center m-5">
            <div>
                <h1 class="hidden md:block text-[3rem]">Pure Worship</h1>
                <p class="text-[1.1rem] md:text-[1.5rem] text-[#3FC1C9]">순전한 예배에 오신 분들과 영상 앞에 모인 분들을 환영합니다.</p>
                <span class="text-[.8rem] text-gray-500 ml-1">예배를 드리는 모든 곳에 주의 임재가 가득하시길 축복합니다.</span> 
                <h1 class="mt-5 p-1 text-[1.5rem] text-[#FF2E63]">주일 예배(1부, 2부)</h1>
                <p class="text-[.8rem] text-gray-500">1부 예배 | 시간: 주일 오전 09:30 | 장소: 강남 순전한교회</p>
                <p class="text-[.8rem] text-gray-500">2부 예배 | 시간: 주일 정오 12:00 | 장소: 도봉 순전한 교회 본당</p>
                <button class="mt-4 text-sm"><a href=""> 더 보기<i class="fas fa-arrow-right ml-1.5 "></i></a></button>
            </div>
            <div class="image m-auto md:m-0 p-[.7em] md:p-[1em] w-[340px] h-[210px] md:w-[660px] md:h-[330px] xl:w-[700px] xl:h-[360px] 2xl:w-[790px] 2xl:h-[380px] 2xl:w-[880px] 2xl:h-[440px] 3xl:w-[990px] 3xl:h-[490px]  border-b-6 border-carnation-pink-400 border-r-6 border-[#F38181]">
       ...
       <!-- Secondary Worships -->
        <section class="secondary mx-auto w-full justify-center items-center md:mt-32">
            <h1 class="text-[3rem] text-center">Pure Worships</h1>
            ...
            <div class="worships m-[1em] md:m-[2em] p-[1em] md:flex space-y-5 justify-between items-center gap-[2em] border-l-4 border-[#94B3FD] border-r-4 border-[#94B3FD]">
                <div class="friend md:mt-5 mx-auto w-[300px] md:w-[340px] p-[1em] bg-[#FCE38A]">
                    <h1 class="m-[2rem] p-1 text-[#FF2E63] text-[1.2rem] md:text-[.8rem] 2xl:text-[.7rem] 3xl:text-[1.3rem] font-semibold">프렌드 어린이 예배</h1>
                ...
                <div class="teenager m-auto w-[300px] md:w-[340px] p-[1em] bg-[#EAFFD0]">
                    <h1 class="m-[2rem] p-1 text-[#FF2E63] text-[1.2rem] md:text-[.8rem] 2xl:text-[.7rem] 3xl:text-[1.3rem] font-semibold">청소년부 예배</h1>
                    <p class="text-[.8rem] text-gray-500">시간: 주일 오전 10:00</p>
                    <p class="text-[.8rem] text-gray-500">장소: 도봉 순전한 교회 본당</p>
                    <a href="" class="items-center text-[.7rem] underline">자세히 보기<i class="fas fa-arrow-right ml-1.5"></i></a>
                </div>
                <div class="thursday m-auto w-[300px] md:w-[340px] p-[1em] bg-[#95E1D3]">
                    <h1 class="m-[2rem] p-1 text-[#FF2E63] text-[1.2rem] md:text-[.8rem] 2xl:text-[.7rem] 3xl:text-[1.3rem] font-semibold">목요 예배</h1>
                ...
                <div class="Bulletin m-auto w-[300px] md:w-[340px] p-[1em] bg-[#95E1D3] bg-cover bg-no-repeat" :style="`background-image: url('https://imgur.com/yCl9ldL.jpg')`">
                    ...
                    <h1 class="mt-[0.5rem] mb-[2.5rem] py-0.5 text-[#FF2E63] text-center w-1/3 md:w-1/2 rounded-lg bg-[#F8F3D4] text-[1.2rem] md:text-[.8rem] 2xl:text-[.7rem] 3xl:text-[1.3rem] font-semibold">오늘의 주보</h1>
