  ...
  <div class="flex bg-gray-100 fonts-sans text-gray-900">
      ...
      <aside class="flex h-screen w-18 flex-col items-center border-r border-gray-200 bg-white">
        ...
        <nav class="flex flex-1 flex-col gap-y-4 pt-10">
            ...
            <button @click="right='text'" class="rounded-xl bg-gray-100 p-2 text-blue-600 hover:bg-gray-50">
                <i class="material-icons-outlined text-blue-700 text-3xl">description</i>
            </button>
            <button @click="right='image'" class="rounded-xl bg-gray-100 p-2 text-blue-600 hover:bg-gray-50">
...
export default {
  ...
  setup() {
    ...
    /* Right - Text */
    const tempImg = ref("https://pbs.twimg.com/media/EJ8BpMMX0AAotgb?format=jpg&name=large");                   // 임시 이미지
